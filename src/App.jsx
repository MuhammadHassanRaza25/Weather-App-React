...
function App() {
  ...
  return (
    <>
      <div className="flex border-b border-gray-300 lg:bg-transparent bg-white justify-between lg:flex-row lg:gap-0 gap-3 flex-col lg:pt-6 lg:pb-5 pt-5 pb-6 lg:px-10 px-5 lg:mb-0 mb-8">
        <div>
